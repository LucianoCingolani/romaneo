...
from app.views import completar_tarea, exportar_tareas_excel, exportar_tareas_pdf, home, agregar_solucion
...
urlpatterns = [
    ...
    path('exportar-excel/', exportar_tareas_excel, name='exportar_tareas_excel'),
